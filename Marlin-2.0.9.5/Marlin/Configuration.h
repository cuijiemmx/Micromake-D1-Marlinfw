...
#define STRING_CONFIG_H_AUTHOR "Cui, Jie" // Who made the changes.
...
// #define MACHINE_UUID "a51e7daa-5478-4588-b4f5-f1fd1edffecd"
...
#define DELTA
  ...
  #define DELTA_RADIUS 96.25              // (mm) Get this value from G33 auto calibrate
...
#define DEFAULT_XYZ_STEPS_PER_UNIT ((XYZ_FULL_STEPS_PER_ROTATION) * (XYZ_MICROSTEPS) / double(XYZ_BELT_PITCH) / double(XYZ_PULLEY_TEETH)) // 100
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 150 }
...
// #define LIMITED_MAX_FR_EDITING        // Limit edit via M203 or LCD to DEFAULT_MAX_FEEDRATE * 2
  ...
  #define MAX_FEEDRATE_EDIT_VALUES    { 400, 400, 400, 400 } // ...or, set your own edit limits
#endif
 ...
 *     O-- FRONT --+
 */
#define Z_PROBE_OFFSET -15
#define NOZZLE_TO_PROBE_OFFSET { 0, 0, Z_PROBE_OFFSET }
...
#define Z_PROBE_OFFSET_RANGE_MIN (Z_PROBE_OFFSET - 5)
#define Z_PROBE_OFFSET_RANGE_MAX (Z_PROBE_OFFSET + 5)
